                            ...
                            <DialogContent>
                                ...
                                <div className="outerRecipeContainerNAM">
                                    <div className="recipeContainerNAM">
                                        ...
                                        <div className = "descNAM">Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default Default </div>
